    ...
    <nav className='bg-purple-100 py-2 px-10'>
      <div className='flex items-center justify-between'>
        ...
        <ul className='hidden md:flex space-x-10'>
          ...
          <li><a href='#' className='text-black font-bold font-Montserrat'>Tasks</a></li>
          <li><a href='#' className='text-black font-bold font-Montserrat'>Pateints</a></li>
          <li><a href='#' className='text-black font-bold font-Montserrat'>Record</a></li>
        </ul>
      </div>
      {isMenuOpen ? (
        <ul className='md:hidden space-y-3'>
          ...
          <li><a href='#' className='text-black font-bold font-Montserrat'>Tasks</a></li>
          <li><a href='#' className='text-black font-bold font-Montserrat'>Patients</a></li>
          <li><a href='#' className='text-black font-bold font-Montserrat'>Record</a></li>
        </ul>
      ):null}
    </nav>
