  ...
  return (
    <footer className="bg-gradient-to-r from-purple-600 to-purple-400 text-white py-16 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><a href="/schedula-a-visit" className="hover:underline">Visit Patients</a></li>
        ...
        <div>
          ...
          <p className="text-sm mb-2"><b>Email:</b> charithmanujaya1@gmail.com</p>
      ...
      <div className="mt-10 border-t border-white/30 pt-6 text-center text-sm">
        &copy; {new Date().getFullYear()} Jcare. All rights reserved. In Remembrance of Our Beloved Janani.
      </div>
    </footer>
  );
};
